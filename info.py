...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('6693372538', '').split()]
...
auth_channel = environ.get('> Auth Channel:> Auth Channel:-1002219034557')
